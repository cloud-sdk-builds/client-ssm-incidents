...
[`@aws-sdk/client-ssm-incidents`](https://www.npmjs.com/package/@aws-sdk/client-ssm-incidents/v/3.1100.0).
...
- @aws-sdk/client-ssm-incidents v3.1100.0 - [https://cloud-sdk-builds.github.io/?sdk=client-ssm-incidents&version=3.1100.0](https://cloud-sdk-builds.github.io/?sdk=client-ssm-incidents&version=3.1100.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-incidents@3.1100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4y4dt+LbzqVTkWc6YgbR/T1n8QzpkmiYMxWgiID2MOQVHECOrs91H3V5gwglDAS2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-incidents": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-incidents@3.1100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-incidents@3.1100.0/index.min.mjs": "sha384-4y4dt+LbzqVTkWc6YgbR/T1n8QzpkmiYMxWgiID2MOQVHECOrs91H3V5gwglDAS2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-incidents/blob/refs/tags/3.1100.0/LICENSE
```
